    ...
    <div class="overflow-y-auto h-screen p-3 mb-9 pb-20">
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2 p-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Becode</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2 p-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">GetFlix</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2 p-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">BookFace</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2 p-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Groupe4</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2 p-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Groupe</h2>
