    ...
    <div class="overflow-y-auto h-screen p-3 mb-9 pb-20">
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2  bg-[#2ECC71]" onclick="window.location.href='dante.html'">
          <div class="w-12 h-12 bg-gray-300 rounded-full mr-3">
            <img src="./img/illustration-3d-adolescent-visage-drole-lunettes.jpg" alt="User Avatar" class="w-12 h-12 rounded-full">
          </div>
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Dante</h2>
            <p class="text-gray-600">Slaaaaaaay!!</p>
          </div>
        </div>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Mike</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Yassine</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Henrique</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Naïm</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Guillaume</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Justin</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Burak</h2>
        ...
        <div class="flex items-center mb-4 cursor-pointer hover:bg-[#07ed5c] p-2 rounded-md m-2  bg-[#2ECC71]">
          ...
          <div class="flex-1">
            <h2 class="text-lg font-semibold">Ayoub</h2>
        ...
        <div class="flex items-center justify-center">
            <button class="hover:scale-110 ">
                <div class="hover:bg-[#07ed5c] rounded-full bg-[#2ECC71]">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" height="24" viewBox="0 -960 960 960" width="24">
